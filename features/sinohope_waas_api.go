...
type CommonAPI interface {
	...
	GetSupportedChains() (*common.Response, error)

	// GetSupportedCoins 查询链支持的币种列表
	// POST: /v1/waas/common/get_supported_coins
	GetSupportedCoins(param *common.WaasChainParam) (*common.Response, error)

	// GetVaults 金库列表
	// POST: /v1/waas/common/get_vaults
	GetVaults() (*common.Response, error)
}
...
type MPCAPI interface {
	...
	CreateWallets(param *common.WaaSCreateBatchWalletParam) (*common.Response, error)

	// ListAddress 查询链地址
	// POST: /v1/waas/mpc/wallet/list_addresses
	ListAddress(param *common.WaaSListAddressesParam) (*common.Response, error)

	// GenerateChainAddresses 生成链地址
	// POST: /v1/waas/mpc/wallet/generate_chain_addresses
	GenerateChainAddresses(param *common.WaaSGenerateChainAddressParam) (*common.Response, error)

	// ListWallets 查询钱包列表
	// POST: /v1/waas/mpc/wallet/list_wallets
	ListWallets(param *common.WaaSListWalletsParam) (*common.Response, error)

	// ListAddedChains 查询指定钱包下已添加地址的链及其首个地址信息
	// POST: /v1/waas/mpc/wallet/list_added_chains
	ListAddedChains(param *common.WaaSListAddedChainsParam) (*common.Response, error)

	// GetAddressBalance 查询地址余额信息
	// POST: /v1/waas/mpc/wallet/get_address_balance
	GetAddressBalance(param *common.WaaSGetAddressBalanceParam) (*common.Response, error)

	// GetWalletBalance 查询指定钱包所有币种的余额信息
	// POST: /v1/waas/mpc/wallet/get_wallet_balance
	GetWalletBalance(param *common.WaaSGetWalletBalanceParam) (*common.Response, error)

	// IsValidAddress 检查币种地址是否正确
	// POST: /v1/waas/mpc/is_valid_address
	IsValidAddress(param *common.WaaSAddressCheckParam) (*common.Response, error)

	// TransferAddressBook 当前金库设置开关以后,支持转账的地址簿
	// POST: /v1/waas/mpc/wallet/transfer_address_book
	TransferAddressBook(param *common.WaaSTransferAddressBookParam) (*common.Response, error)

	// TransferRiskControlSwitch 查询当前金库是否设置了风控开关
	// POST: /v1/waas/mpc/wallet/transfer_risk_control_switch
	TransferRiskControlSwitch(param *common.WaaSVaultIdDTO) (*common.Response, error)

	// CreateTransfer 发起转账交易
	// POST: /v1/waas/mpc/transaction/create_transfer
	CreateTransfer(param *common.WalletTransactionSendWAASParam) (*common.Response, error)

	// CreateTransaction 发起任意交易
	// POST: /v1/waas/mpc/transaction/create_transaction
	CreateTransaction(param *common.WalletTransactionSendDataWAASParam) (*common.Response, error)

	// SpeedupTransaction 交易加速
	// POST: /v1/waas/mpc/transaction/speedup_transaction
	SpeedupTransaction(param *common.WalletTransactionSpeedupWAASParam) (*common.Response, error)

	// CancelTransaction 交易取消，该方法只支持类eth系列交易取消
	// POST: /v1/waas/mpc/transaction/cancel_transaction
	CancelTransaction(param *common.WalletTransactionCancelWAASParam) (*common.Response, error)

	// ListTransactions 交易列表
	// POST: /v1/waas/mpc/transaction/list_transactions
	ListTransactions(param *common.WalletTransactionQueryWAASParam) (*common.Response, error)

	// TransactionsByRequestIds 根据requestIds查询交易列表
	// POST: /v1/waas/mpc/transaction/transactions_by_request_ids
	TransactionsByRequestIds(param *common.WalletTransactionQueryWAASRequestIdParam) (*common.Response, error)

	// TransactionsBySinoIds 根据sinoIds查询交易列表
	// POST: /v1/waas/mpc/transaction/transactions_by_sino_ids
	TransactionsBySinoIds(param *common.WalletTransactionQueryBySinoIdParam) (*common.Response, error)

	// TransactionsByTxHash 根据txHash查询交易列表
	// POST: /v1/waas/mpc/transaction/transactions_by_tx_hash
	TransactionsByTxHash(param *common.WalletTransactionQueryWAASTxHashdParam) (*common.Response, error)

	// SignMessage 按已知的规范签名消息（EIP-191、 EIP-712）
	// POST: /v1/waas/mpc/web3/sign_message
	SignMessage(param *common.SignMessageParam) (*common.Response, error)
}
...
type MPCNodeAPI interface {
	...
	ListMPCRequests(param *common.WaasMpcNodeExecRecordParam) (*common.Response, error)
